...
<div id="mainContainer">
    <div id="mainRow">
        <section id="main">
                    ...
                    <table>
                        ...
                        <c:forEach items="${ordersOfTrackingProject}" var="order">
                            <tr>
                                <td>${order.id}</td>
                                <td>${order.feature}</td>
                                <td><a href=<c:url value='/employee/tracking/${trackingProject.id}/${order.id}/history'/>>Show history</a></td>
                                <td><a href=<c:url value='/employee/tracking/${trackingProject.id}/${order.id}/input_track'/>>New track</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </section>
            ...
            <p><a href=<c:url value='/employee/tracking'/>><< full tracking list</a></p>
        </section>
        <section id="news">
