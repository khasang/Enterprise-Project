...
//    }
    ...
    public void findAllEmployeesTest() throws Exception {
        ...
        Assert.assertEquals("employeepassword", employee.get(1).getPassword());
        Assert.assertEquals("employeepassword1", employee.get(2).getPassword());
        Assert.assertEquals("employeepassword2", employee.get(3).getPassword());
    }
    ...
    public void deleteEmployeeByLoginTest() throws Exception {
        ...
        employeeDao.deleteEmployeeByLogin("employeelogin2");
    ...
    public void findClientByLoginTest() throws Exception {
        Client client = clientDao.findByLogin("ClientLogin1");
        Assert.assertEquals("er1@yt.ty", client.getEmail());
        Assert.assertEquals("clientpassword1", client.getPassword());
    }
    ...
    public void attributePropertiesTest() throws Exception {
        ...
        Assert.assertEquals("2018-04-05", newsDao.findAll().get(0).getPublishDate().toString());
    }
